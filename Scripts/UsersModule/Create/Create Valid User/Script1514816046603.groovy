...
WebUI.setText(findTestObject('GIAP-DC/UserModule/NameUser'), GlobalVariable.NewUser)
...
'Проверяем заголовок окна нового пользователя'
not_run: WebUI.verifyTextPresent('Новый пароль для пользователя', false)
