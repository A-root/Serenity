...
WebUI.setText(findTestObject('GIAP-DC/UserModule/input_0_1'), GlobalVariable.NewName)

'Сохраняем изменения'
WebUI.click(findTestObject('GIAP-DC/UserModule/SaveButton'))

'Проверяем наличие сообщения об успехе'
not_run: WebUI.verifyElementPresent(findTestObject('GIAP-DC/UserModule/Error'), 3)
