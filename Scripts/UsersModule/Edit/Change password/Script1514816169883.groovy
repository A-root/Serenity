...
WebUI.click(findTestObject('GIAP-DC/UserModule/button_generate-pwd'))

'Сохраняем'
WebUI.click(findTestObject('GIAP-DC/UserModule/SaveButton'))

'Проверяем заголовок окна нового пароля'
not_run: WebUI.verifyElementPresent(findTestObject('GIAP-DC/UserModule/HeaderNewPass'), 3)
