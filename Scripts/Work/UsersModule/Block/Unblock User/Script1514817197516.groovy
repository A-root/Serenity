...
WebUI.click(findTestObject('GIAP-DC/UserModule/a_unblock btn green-dark'))

WebUiBuiltInKeywords.delay(GlobalVariable.Delay)

'Подтверждаем разблокировку'
WebUI.click(findTestObject('GIAP-DC/UserModule/HeaderUnblockUser'))

'Подтверждаем разблокировку'
WebUI.click(findTestObject('GIAP-DC/UserModule/UnblockUserButton'))

'Проверяем подтверждение разблокировки'
