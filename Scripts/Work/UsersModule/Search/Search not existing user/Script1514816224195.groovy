...
'Ищем пользователя'
WebUI.setText(findTestObject('GIAP-DC/UserModule/search_user'), 'test10101010')

'Проверяем, что такого пользователя не найдено'
WebUI.verifyTextPresent('Ничего не найдено', false)
