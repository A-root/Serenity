...
WebUiBuiltInKeywords.click(findTestObject('GIAP-DC/Vessel/Operating Parameters/History/historyButton'))
...
WebUiBuiltInKeywords.setText(findTestObject('GIAP-DC/Vessel/Operating Parameters/History/DateHistory'), '25.05.2014')
...
WebUiBuiltInKeywords.setText(findTestObject('GIAP-DC/Vessel/Operating Parameters/History/workPin'), '0.05')

WebUiBuiltInKeywords.setText(findTestObject('GIAP-DC/Vessel/Operating Parameters/History/workPout'), '0,05')

WebUiBuiltInKeywords.setText(findTestObject('GIAP-DC/Vessel/Operating Parameters/History/allowedP'), '0.05')

WebUiBuiltInKeywords.setText(findTestObject('GIAP-DC/Vessel/Operating Parameters/History/calculatedP'), '0.05')
